...
public class GgpRegressionSolution extends PipelineEvaluationReport {

	private IComponentInstance regressorComponentInstance;
	private IComponentInstance featureExtractorComponentInstances;

	public GgpRegressionSolution(final String constructionInstruction, final String imports, final IComponentInstance regressorComponentInstance, final IComponentInstance iComponentInstance, final Double performance) {
