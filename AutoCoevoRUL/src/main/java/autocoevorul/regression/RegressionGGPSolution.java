...
public class RegressionGGPSolution extends PipelineEvaluationReport {
	...
	public RegressionGGPSolution(final String constructionInstruction, final String imports, final IComponentInstance regressorComponentInstance, final IComponentInstance iComponentInstance, final Double performance) {
