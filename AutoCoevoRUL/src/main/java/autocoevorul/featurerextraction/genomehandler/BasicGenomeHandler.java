...
public class BasicGenomeHandler extends GenomeHandler {
	...
	public Solution activateTsfresh(final Solution solution) {
		String[] parameterName = new String[] { "has_duplicate_max", "binned_entropy", "last_location_of_maximum", "abs_energy", "c3", "value_count", "mean_second_derivative_central", "first_location_of_minimum", "standard_deviation",
				"length", "mean_abs_change", "has_duplicate_min", "mean_change", "sum_values", "percentage_of_reoccurring_datapoints_to_all_datapoints", "range_count", "absolute_sum_of_changes", "energy_ratio_by_chunks",
				"last_location_of_minimum", "linear_trend", "variance_larger_than_standard_deviation", "spkt_welch_density", "cid_ce", "symmetry_looking", "has_duplicate", "skewness", "count_above", "count_above_mean",
				"longest_strike_below_mean", "mean", "agg_autocorrelation", "ratio_value_number_to_time_series_length", "fft_aggregated", "first_location_of_maximum", "partial_autocorrelation", "sum_of_reoccurring_data_points",
				"count_below", "count_below_mean", "variance", "longest_strike_above_mean", "median", "kurtosis", "minimum", "time_reversal_asymmetry_statistic", "number_crossing_m", "sum_of_reoccurring_values", "maximum" };
		...
		this.activateRandomValueMaskingStrategy(solution);
		return solution;
	}
