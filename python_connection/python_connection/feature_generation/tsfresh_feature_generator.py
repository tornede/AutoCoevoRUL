...
class FCParametersDictionary(dict):
    def __init__(self, has_duplicate_max=False, binned_entropy=False, last_location_of_maximum=False, abs_energy=False, c3=False, value_count=False, mean_second_derivative_central=False, first_location_of_minimum=False, standard_deviation=False, length=False, mean_abs_change=False, has_duplicate_min=False, mean_change=False, sum_values=False, percentage_of_reoccurring_datapoints_to_all_datapoints=False, range_count=False, absolute_sum_of_changes=False, energy_ratio_by_chunks=False, last_location_of_minimum=False, linear_trend=False, variance_larger_than_standard_deviation=False, spkt_welch_density=False, cid_ce=False, symmetry_looking=False, has_duplicate=False, skewness=False, count_above=False, count_above_mean=False, longest_strike_below_mean=False, mean=False, agg_autocorrelation=False, ratio_value_number_to_time_series_length=False, fft_aggregated=False, first_location_of_maximum=False, partial_autocorrelation=False, sum_of_reoccurring_data_points=False, count_below=False, count_below_mean=False, variance=False, longest_strike_above_mean=False, median=False, kurtosis=False, minimum=False, time_reversal_asymmetry_statistic=False, number_crossing_m=False, sum_of_reoccurring_values=False, maximum=False, approximate_entropy=False, number_cwt_peaks=False, augmented_dickey_fuller=False, quantile=False, agg_linear_trend=False, max_langevin_fixed_point=False, friedrich_coefficients=False, fft_coefficient=False, large_standard_deviation=False, autocorrelation=False, cwt_coefficients=False, percentage_of_reoccurring_values_to_all_values=False, ar_coefficient=False, ratio_beyond_r_sigma=False, number_peaks=False, sample_entropy=False, change_quantiles=False, index_mass_quantile=False):
        initial_map = ComprehensiveFCParameters()
        initial_map.pop("linear_trend_timewise")  # broken
